...
for (const directory of ['models', 'community', 'languages', 'debuggers', 'training', 'academy', 'blueprint', 'plugins', 'tasks']) await cp(path.join(root, directory), path.join(frontend, directory), { recursive: true });
